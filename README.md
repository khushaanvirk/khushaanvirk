...
**[65% Mechanical Keyboard PCB](https://github.com/khushaanvirk/khushaan65)** · Altium, STM32, bare-metal C
67-key hot-swap board. STM32F072 with crystal-less USB, 4-layer stackup, 90 Ω USB differential pair computed by hand from the real prepreg geometry. Fabbed and assembled at JLCPCB, worked on the first spin, and it is the board I type on. Bare-metal USB HID firmware with no HAL and no CubeMX.
